...
CREATE OR REPLACE PROCEDURE `rax-abo-72-dev`.sales.udsp_load_cloud_us_contact_info()
begin


create or replace table `rax-abo-72-dev`.sales.cloud_us_account_contact_info_current as
SELECT DISTINCT
    Cloud_Account_Key									     AS Account_Key,
    Account_ID,
    SF_Account_ID											AS SF_Account_ID,
    QA_Account_ID											AS QA_Account_ID,
    Keizan_Core_Account,
    Keizan_Match_Date,
    Account_Number,
