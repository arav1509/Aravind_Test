...
trigger_NRD_GDO_Fact_Tables_dag = TriggerDagRunOperator(
        task_id="trigger_NRD_GDO_Fact_Tables_dag",
        trigger_dag_id="NRD_GDO_Fact_Tables",
...
NRD_GDO_DIM_Tables_End >> trigger_NRD_GDO_Fact_Tables_dag